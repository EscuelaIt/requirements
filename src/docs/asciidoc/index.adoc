...
.2+a| [red]#Mastermind. Requisitos. Versión 1. **Básica**#
a| [red]#Mastermind. Solucion. Versión 1.1. **domainModel**#
...
a| [red]#Mastermind. Solucion. Versión 2.1. **documentView**#
...
.6+a| [blue]#Mastermind. Requisitos. Versión 2. **Gráficos**#

a| [blue]#Mastermind. Solucion. Versión 3.2. **dv.withoutFactoryMethod**#
...
a| [blue]#Mastermind. Solucion. Versión 4.2. **dv.withFactoryMethod**#
...
a| [blue]#Mastermind. Solucion. Versión 5.2. **modelViewPresenter.presentationModel**#
...
a| [blue]#Mastermind. Solucion. Versión 6.2. **mvp.pm.withFacade**#
a| [blue]#Clase Lógica que encapsula Controladores y Modelos **pero con Vistas con DRY en la Lógica de Control**#



a| [blue]#Mastermind. Solucion. Versión 7.2. **mvp.pm.withoutDoubleDispatching**#
...
a| [blue]#Mastermind. Solucion. Versión 8.2. **mvp.pm.withDoubleDispatching**#
...
a| [green]#Mastermind. Solucion. Versión 9.3. **mvp.pm.withComposite**#
a| [green]#Clase Comando del menú y Controlador Compuesto de ciertos Estados para Open/Close con nuevos Casos de Uso#


.2+a| [yellow]#Mastermind. Requisitos. Versión 4. **ClienteServidor**#
a| [yellow]#Mastermind. Solucion. Versión 10.4. **mvp.pm.withoutProxy**#
...
a| [yellow]#Mastermind. Solucion. Versión 11.4. **mvp.pm.withProxy**#
a| [yellow]#Clases Proxy para Open/Close para nuevas tecnologías de Despliegue#


.2+a| [purple]#Mastermind. Requisitos. Versión 5. **Ficheros**#
a| [purple]#Mastermind. Solucion. Versión 12.5. **mvp.pm.withoutDAO**#
...
a| [purple]#Mastermind. Solucion. Versión 13.5. **mvp.pm.withDAO**#
a| [purple]#Patrón DAO#


.2+a| [lime]#Mastermind. Requisitos. Versión 6. **BasesDatos**#
a| [lime]#Mastermind. Solucion. Versión 14.6. **mvp.pm.withoutPrototype**#
...
a| [lime]#Mastermind. Solucion. Versión 15.6. **mvp.pm.withPrototype**#
a| [lime]#Open/Close para arranque con configuración de persistencia#

.3+a| [red]#*Arquitectura del Software*#
.3+a| [red]#Mastermind. Requisitos. Versión 1. **Básica**#
a| [red]#Mastermind. Solucion. Versión 16.1. **mvp.pv**#
a| [red]#Baile de la Triada#



a| [red]#Mastermind. Solucion. Versión 17.1. **mvp.sc**#
a| [red]#Baile de la Triada#



a| [red]#Mastermind. Solucion. Versión 18.1. **mvc**#
a| [red]#Baile de la Triada#
